               ...
               <div className='relative max-w-7xl mx-auto'>
                <div className='flex h-[650px] justify-center items-center lg:pt-0 pt-20'>
                    <div className='flex flex-col space-y-8 justify-center items-center text-center px-5 md:px-0'>
                        <h1 className='text-blue-200 font-bold text-4xl lg:text-6xl'>Discover Your Next Adventure</h1>
                        <p className='text-blue-200 lg:text-lg lg:w-[700px]'>Explore breathtaking destinations, create unforgettable memories and embark on the journey of a lifetime.</p>
                        <button className=' hover:shadow-red-400 hover:text-blue-950  bg-red-500 px-3 py-2 text-white rounded-md font-semibold hover:px-4 hover:bg-blue-200'>Start Exploring</button>
                    </div>
                </div>
               </div>
          </div>
